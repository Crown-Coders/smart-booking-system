...
export default function TherapistCalendar() {
  ...
  const sessions = [
    { id: 1, patient: 'John Doe', time: '10:00 AM', type: 'Therapy Session' },
    { id: 2, patient: 'Jane Smith', time: '2:00 PM', type: 'Follow-up' },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        {selectedDate.getDate() === 20 || selectedDate.getDate() === 22 ? (
          ...
          <Card>
            <Text style={styles.noSessionsText}>No sessions scheduled for this day</Text>
          </Card>
        )}
      </ScrollView>
    </View>
